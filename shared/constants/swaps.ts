...
export const HZC_SWAPS_TOKEN_OBJECT: SwapsTokenObject = {
  symbol: CURRENCY_SYMBOLS.HZC,
  name: 'HZC',
  address: DEFAULT_TOKEN_ADDRESS,
  decimals: 18,
  iconUrl:HIZOCO_TOKEN_IMAGE_URL,
};
...
const HIZOCO_CONTRACT_ADDRESS='0x881d40237659c251811cec9c364ef91dc08d300c';
...
export const WETH_HIZOCO_CONTRACT_ADDRESS=
  '0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2';
...
const HIZOCO_DEFAULT_BLOCK_EXPLORER_URL="https://hizoco.net/rpc/";
...
export const SWAPS_CHAINID_CONTRACT_ADDRESS_MAP = {
  ...
  [CHAIN_IDS.HIZOCO]:HIZOCO_CONTRACT_ADDRESS,
...
export const SWAPS_WRAPPED_TOKENS_ADDRESSES = {
  ...
  [CHAIN_IDS.HIZOCO]:WETH_HIZOCO_CONTRACT_ADDRESS,
...
export const ALLOWED_CONTRACT_ADDRESSES = {
  ...
  [CHAIN_IDS.HIZOCO]:[
    SWAPS_CHAINID_CONTRACT_ADDRESS_MAP[CHAIN_IDS.HIZOCO],
    SWAPS_WRAPPED_TOKENS_ADDRESSES[CHAIN_IDS.HIZOCO],
  ],
  [SWAPS_TESTNET_CHAIN_ID]: [
...
export const SWAPS_CHAINID_DEFAULT_TOKEN_MAP = {
  ...
  [CHAIN_IDS.HIZOCO]:HZC_SWAPS_TOKEN_OBJECT,
...
export const SWAPS_CHAINID_DEFAULT_BLOCK_EXPLORER_URL_MAP: BlockExplorerUrlMap =
  {
    ...
    [CHAIN_IDS.HIZOCO]:HIZOCO_DEFAULT_BLOCK_EXPLORER_URL,
